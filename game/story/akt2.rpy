label akt2:
    ...
    scene bg akihabara2
    "Nejdřive jste zašli do obchodního centra Yodobashi akiba, kde jste proůezli všechny patra."
    scene bg yodobashi elektronika
    "Přes první patro, kde byla různá elektronika."
    scene bg yodobashi elektronika2 
    "Myši, mobili, počítače, powerbanky..."
    ...
    "Po krátké diskuzi se rozhodnete navštívit ichiran."
    scene bg akihabara
    ...
    "Avšak jeden z Japonců vám pro urychlení podává, meníčko pro zakroužkování spravného rámenu."
